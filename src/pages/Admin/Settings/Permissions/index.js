  ...
  return (
    <>
        ...
        <div className={"p-4"}>
          <>
            <div className={"mb-5 fw-medium font-size-18"}>
              <div className={"mb-4 border-bottom pb-3"}>Информация о доступе</div>
              <div className={"row gy-3"}>
                <div className="col-5">Названия:</div>
                <div className="col-7">{get(role,"name", "-")}</div>
                <div className="col-5">Описание:</div>
                <div className="col-7">{get(role,"description", "-")}</div>
                <div className="col-5">URL:</div>
                <div className="col-7">{get(role,"url", "-")}</div>
              </div>
            </div>
          </>
      ...
      <div className="d-flex align-items-center justify-content-between py-4">
        <h1 className="font-size-24 text-dark-blue fw-semibold">Список управления доступом</h1>
                  ...
                  ? <div className="table-responsive">
                    <table className="table table-borderless table-separate spaceY-1">
                      ...
                      <tr>
                        ...
                        <th className="p-3 fw-normal">Названия</th>
                        <th className="p-3 fw-normal">Описание</th>
                      ...
                      <tbody className="row-bg-white">
                      {
                        data.map((item, key) => (
                          <tr className="rounded-2" key={key}>
                            ...
                            <td className="fw-medium p-3 p-lg-4 align-middle rounded-start">
                              <span className="text-secondary">{get(item,'description','')}</span>
                            </td>
