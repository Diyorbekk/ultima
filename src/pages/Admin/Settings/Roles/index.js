  ...
  return (
    <>
        ...
        <div className={"p-4"}>
          <>
            <div className={"mb-5 fw-medium font-size-18"}>
              <div className={"mb-4 border-bottom pb-3"}>Информация о роли</div>
              <div className={"row gy-3"}>
                <div className="col-5">Описание:</div>
                <div className="col-7">{get(role,"description_ru", "-")}</div>
                <div className="col-5">Ключевое слово:</div>
                <div className="col-7">{get(role,"key", "-")}</div>
                <div className="col-5">ID:</div>
                <div className="col-7">{get(role,"id", "-")}</div>
              </div>
            </div>
          </>
      ...
      <div className="d-flex align-items-center justify-content-between py-4">
        <h1 className="font-size-24 text-dark-blue fw-semibold">Роли</h1>
      ...
      >
        {({ isFetched, data=[], meta={}}) => {
          ...
          return <>
                ...
                ? <div className="table-responsive">
                  <table className="table table-borderless table-separate spaceY-1">
                    ...
                    <tr>
                      ...
                      <th className="p-3 fw-normal">Названия на узб.</th>
                      <th className="p-3 fw-normal">Названия на рус.</th>
                      <th className="p-3 fw-normal">Ключевое слово</th>
                      <th className="p-3 fw-normal">Доступы</th>
                      ...
                      data.map((item, key) => (
                        <tr className="rounded-2" key={key}>
                          ...
                          <td className="fw-medium p-3 p-lg-4 align-middle rounded-start">
                            <span className="text-secondary">{get(item,'description_uz','')}</span>
                          </td>
                          <td className="fw-medium p-3 p-lg-4 align-middle rounded-start">
                            <span className="text-secondary">{get(item,'description_ru','')}</span>
                          </td>
                          <td className="fw-medium p-3 p-lg-4 align-middle rounded-start">
                            <span className="text-secondary">{get(item,'key','')}</span>
                          </td>

                          <td className="fw-medium p-3 p-lg-4 align-middle rounded-start">
                            <Link to={"#!"} className="font-size-22"><i className={"fal fa-list"}/></Link>
                          </td>
            ...
            {
              Object.keys(meta) && meta?.total > perPage
                ? <Pagination
