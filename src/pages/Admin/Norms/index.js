  ...
  return (
    <>
      ...
      >
        <div className={"p-4"}>
          <div className={"mb-5 fw-medium font-size-18"}>
            <div className={"mb-3"}>Информация о норме:</div>
            <div>{get(selectedObject,'description')}</div>
          </div>
      ...
      <div className="d-flex align-items-center justify-content-between py-4">
        <h1 className="font-size-24 text-dark-blue fw-semibold">Нормы</h1>
                        ...
                        data.length
                          ? data.map((item, key) => (
                            <tr key={key}>
                              ...
                              <td className="fw-medium p-3 p-lg-4">{get(item,'description')}</td>
