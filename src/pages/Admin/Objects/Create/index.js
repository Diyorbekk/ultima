    ...
    <div id="homepage2" className="px-lg-4 px-3 flex-fill">
      ...
      <div className="">
        <div className="bg-white rounded-3 shadow-sm p-4 mb-3">
            <h1 className="font-size-18 mb-4">Добавление нового объекта</h1>
            <MyForm
              className={""}
              t={t}
              fields={[
                ...
                },
                {
                  ...
                  required: true,
                  type: 'object',
                  onSubmitValue: date => `${date.year}-${date.month}-${date.day}`
                },
                {
              ...
              onSubmit={({ values, setSubmitting}) => {
                const descriptions = values.file.map((item) => {
                      ...
                      <div className="col-12 col-xxl-4 col-md-6">
                        <div className="mb-4">
                          ...
                          <DatePicker
                            ...
                            inputClassName={`form-control font-size-15 focus-none text-start ${createErrorClass(errors, touched, "registration_date")}`}
                            type="date"
                            id="date"
                            ...
                            onChange={date => {
                              setFieldValue('registration_date', date);
                            }}
                            onBlur={() => {
                              setFieldTouched('registration_date', true)
                            }}
                          />
                        </div>
                      </div>
